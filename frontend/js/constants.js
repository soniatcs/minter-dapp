const contractAddress = "0x5Cc9b4D5D1431673aE806899895532CC027d171b"; // Replace with your own contract address
const chain = 'goerli'; // goerli, polygon, or ethereum

const welcome_h1 = "Welcome to the TESTING NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The TESTING NFT Project is a decentralized, open-source project that aims to demonstrate how to develope and launch your own NFT Collection. target="_blank" rel="noopener noreferrer">testing</a>.';
